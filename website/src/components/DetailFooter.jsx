  ...
  return (
    <div className="flex flex-col items-left bg-black py-4 px-6">
      <div className="flex items-center justify-between mb-4">
        <div className="text-white text-3xl font-bold">All NFTs</div>
        <button className="w-44 h-16 p-4 rounded-lg border border-blue-600 hover:bg-blue-700 justify-center items-start gap-2.5 inline-flex">
