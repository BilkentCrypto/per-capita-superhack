...
const NftCard = ({ title, imageUrl, index, onClick, isWinner }) => {
  return (
    <div onClick={onClick}
      className="scale-[1.00] w-96 h-[400px] flex flex-col items-center  hover:scale-[1.05] hover:cursor-pointer">
      ...
      <div className="w-96 h-[400px] scale-[1.00] overflow-hidden bg-gray-800 rounded-3xl flex flex-col items-center justify-center">
      {isWinner && (
        ...
        <img
          src={imageUrl}
          alt="NFT"
          className="select-none w-[336px] h-[220px] rounded-3xl object-cover"
        />
