...
getData()
  ...
  return (
    <div className="w-400 h-536 bg-gray-700 rounded-3xl p-6 flex flex-col items-start justify-center shadow-lg">
      <img
        src={image}
        className="self-center h-[250px] object-contain mb-5 rounded-xl"
      />
      ...
      <div className="flex items-center">
        <button onClick={() => handleClick()} className="bg-[#7316ff] mt-2 text-white text-base font-medium px-4 py-2 rounded-lg hover:bg-[#7d27ff] hover:scale-[1.03]">
          Join Now
        </button>
      </div>
    </div>
